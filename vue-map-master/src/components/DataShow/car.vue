...
<template>
  <div class="info">
    <div class="info-title">车辆卡口统计</div>
    <el-tabs v-model="activeName">
      <el-tab-pane label="查询条件" name="first">
        <div >
          <el-form ref="form" :model="form"  label-width="80px" >
            <el-form-item label="车牌号" prop="camIds">
      ...
      <el-tab-pane label="查询结果" name="third">
        ...
        <el-button type="primary" style="margin-top: 10px" @click="showData">展示轨迹</el-button>
      </el-tab-pane>
...
import {searchCarTrajectory} from "../../api/map";
